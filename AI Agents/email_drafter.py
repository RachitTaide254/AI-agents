...
def our_agent(state:AgentState) -> AgentState:
    ...
    You are a drafter a helpful writing assistant. You are going to help the user update and modify document.
    - If the user wants to update or modify the content, use the 'update' tool with the complete updated content.
    - If the user want to save and finish, you nedd to use 'save' tool.
    ...
    if hasattr(response,"tools_call") and response.tool_calls:
